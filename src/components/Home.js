...
import imgGirl from "../images/therapy.jpg";
import imgBoy from "../images/happy.jpg";
            ...
            <div className="hero-content-inner" ref={el => content = el}>
              <h1>
                <div className="hero-content-line">
                  <div className="hero-content-line-inner">Hack For</div>
                </div>
                <div className="hero-content-line">
                  <div className="hero-content-line-inner">The <strong>People</strong></div>  
                </div>
              </h1>
              <p>
              ...
              <div className="btn-row">
                <button className="explore-button">Scroll
                  <div className="arrow-icon">
                    <img className="rotate" src={arrow} alt="row"/>
                  </div>
                </button>
              </div>
            </div>
